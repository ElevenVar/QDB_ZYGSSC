import { arrayFindIndex } from '@/componentsEl/src/utils/util';
import { getCell, getColumnByCell, getRowIdentity } from './util';
import { getStyle, hasClass, removeClass, addClass } from '@/componentsEl/src/utils/dom';
import ElCheckbox from '@/componentsEl/checkbox';
import ElTooltip from '@/componentsEl/tooltip';
      ...
      return (<tr
        ...
        on-mouseleave={ this.handleMouseLeave }>
        {
          columns.map((column, cellIndex) => {
            ...
            if(column.type === 'selection' &&  row.data.parentId){
                return <td
