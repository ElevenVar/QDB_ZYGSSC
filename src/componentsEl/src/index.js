...
import locale from '@/componentsEl/src/locale';
import CollapseTransition from '@/componentsEl/src/transitions/collapse-transition';

import ElxEditable from '../elxTable/editable/index.js';
import ElxTable from '../elxTable/table/index.js';
import ElxEditableColumn from '../elxTable/editable-column/index.js';
import ElxTableColumn from '../elxTable/table-column/index.js';
...
export default {
  version: '2.11.1',
  ElxEditable:ElxEditable,
  ElxTable:ElxTable,
  ElxEditableColumn:ElxEditableColumn,
  ElxTableColumn:ElxTableColumn,
  locale: locale.use,
  i18n: locale.i18n,
  install,
  CollapseTransition,
