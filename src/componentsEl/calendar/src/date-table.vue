<script>
import fecha from '@/componentsEl/src/utils/date';
import { range as rangeArr, getFirstDayOfMonth, getPrevMonthLastDays, getMonthDays, getI18nSettings, validateRangeInOneMonth } from '@/componentsEl/src/utils/date-util';
