...
export default {
  ...
  methods: {
    ...
    setCurrentRow (record) {
      let matchObj = XEUtils.findTree(this.datas, row => row.data === record, this.elTreeOpts)
      return matchObj ? this.$refs.refElTable.setCurrentRow(matchObj.item) : this.$refs.refElTable.setCurrentRow()
    },
    clearSort () {
    ...
    /****************************/
    resizeListener(){
      this.$refs['refElTable'].resizeListener()
    }
  }
}
</script>
