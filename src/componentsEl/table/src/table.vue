...
<script type="text/babel">
  import ElCheckbox from '@/componentsEl/checkbox';
  import { debounce, throttle } from 'throttle-debounce';
  import { addResizeListener, removeResizeListener } from '@/componentsEl/src/utils/resize-event';
  import Mousewheel from '@/componentsEl/src/directives/mousewheel';
    ...
    computed: {
      ...
      fixedHeight() {
        if (this.maxHeight) {
          ...
          return {
            height: this.layout.tableHeight ? this.layout.tableHeight + 'px' : '' // todo 强行修改
          };
        }
      },
